                ...
                <div className="about-studio-section">
                    ...
                    <div className="about-studio-content">
                        ...
                        <div className="about-studio-text">
                            {isEn 
                                ? 'In his studio, handcrafted lighting fixtures are created, combining wood, metal, and glass to create functional objects with a sculptural presence.\n\nThe works are born from a dialogue with space, light, and people.\nEach lighting fixture is created to illuminate the place, but also to define the atmosphere within it.\n\nTiran works in collaboration with architects and interior designers who are looking for precise, high-quality, and timeless lighting solutions.'
